...
static const char *defaulttagapps[] = { "st", NULL, NULL, NULL, NULL, NULL, NULL, NULL, "discord" };
...
static const char *launchthunar[]   = { "thunar", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_w,      spawn,          {.v = launchfirefox } },
	{ MODKEY,                       XK_e,      spawn,          {.v = launchthunar } },
	...
	TAGKEYS(                        XK_8,                      7)
	TAGKEYS(                        XK_9,                      8)
	{ MODKEY|ShiftMask,             XK_F12,    exitdwm,        {0} },
